...
//! diff_file`) into gutter marks and hunk-revert edits -- no `ratatui`,
//! no I/O, ported near-verbatim from `crates/ui/src/editor/git_gutter.rs`
//! (`docs/features/tui-git-gutter.md` §2.1).
...
/// marks -- see `docs/features/tui-git-gutter.md` §2.1 for the
...
/// hunk covers it (`docs/features/tui-git-gutter.md` §2.1).
